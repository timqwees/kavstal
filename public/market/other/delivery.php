        ...
        <div class="bg-white rounded-2xl shadow-md p-8">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="mb-6 md:mb-0 md:mr-8">
                    ...
                    <p class="text-gray-600 mb-4">Проектируемый проезд № 8342, вл. 5
                        Хованская промзона
                        Перед приездом на погрузку необходимо заранее согласовать дату и время с менеджером и направить данные на автомобиль и водителя для оформления пропуска.
                        В зависимости от выбранной продукции отгрузка также может осуществляться с железнодорожного тупика или напрямую с заводских остатков. Адрес и условия погрузки в таком случае уточняйте у вашего менеджера.</p>
                </div>
                <a href="/contacts"
