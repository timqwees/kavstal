            ...
            <div class="flex items-center justify-between h-16 lg:h-20">
                <a href="/" class="flex items-center flex-shrink-0">
                    <img loading="lazy" class="h-10 lg:h-12"
                        src="<?= $site['baseUrl']; ?>/public/assets/images/icons/logo/logo.svg"
                        alt="КАВ СТАЛЬ">
                </a>
                <div class="hidden lg:flex items-center space-x-1">
                    ...
                    <a href="/services" class="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg transition">Услуги</a>
    ...
    <div class="mobile-menu-overlay fixed inset-0 bg-black/50 z-40 lg:hidden">
        <div class="absolute right-0 top-0 h-full w-72 bg-white shadow-xl p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="/services" class="block py-3 px-4 text-red-600 bg-red-50 rounded-lg font-medium">Услуги</a>
