...
<body class="bg-gray-50">
    ...
    <main id="main-content" class="max-w-7xl mx-auto px-4 pt-[120px] pb-12">
        ...
        <div class="mt-12 space-y-10">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <button class="accordion-header w-full flex items-center justify-between p-6 lg:p-8 text-left" aria-expanded="true" data-accordion="desc">
                    <h2 class="text-xl font-bold text-gray-900">Описание</h2>
            ...
            <!-- Full Specs Table — Accordion -->
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" data-section="specs">
                <button class="accordion-header w-full flex items-center justify-between p-6 lg:p-8 text-left" aria-expanded="true" data-accordion="specs">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <button class="accordion-header w-full flex items-center justify-between p-6 lg:p-8 text-left" aria-expanded="false" data-accordion="delivery">
                    <h2 class="text-xl font-bold text-gray-900">Доставка и оплата</h2>
                    <svg class="accordion-icon w-5 h-5 text-gray-400 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div class="accordion-body px-6 lg:px-8 pb-6 lg:pb-8">
